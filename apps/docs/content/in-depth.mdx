...
```tsx
import { IStringDefaultProps } from '@glifxyz/zodform';
...
the component definition. All those interfaces can be imported from `@glifxyz/zodform`, and are as follows:
...
```tsx
import { Form } from '@glifxyz/zodform';
